        ...
        <nav class="sidebar-main">
          <ul class="nav nav-drawer">
            ...
            <li class="nav-item nav-item-has-subnav">
              ...
              <ul class="nav nav-subnav">
                <li> <a href="lyear_forms_elements.html">程序代码 (学生)</a> </li>
              </ul>
            </li>
            <li class="nav-item nav-item-has-subnav">
              <a href="javascript:void(0)"><i class="mdi mdi-file-outline"></i> 技术文档管理</a>
              <ul class="nav nav-subnav">
                <li> <a href="lyear_pages_doc.html">技术文档</a> </li>
              </ul>
            </li>
            <li class="nav-item nav-item-has-subnav">
          ...
          <ul class="topbar-right">
            <li class="dropdown dropdown-profile">
              ...
              <ul class="dropdown-menu dropdown-menu-right">
                <li> <a href="${pageContext.request.contextPath }/topersonInfo"><i class="mdi mdi-account"></i> 个人信息</a> </li>
