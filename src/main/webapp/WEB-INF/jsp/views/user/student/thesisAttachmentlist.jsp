						...
						<ul class="nav nav-drawer">
							...
							<li class="nav-item nav-item-has-subnav"><a
								href="javascript:void(0)"><i class="mdi mdi-file-outline"></i>
									技术文档管理</a>
								<ul class="nav nav-subnav">
									<li><a href="${pageContext.request.contextPath }/student/projBooklist">技术文档</a></li>
								</ul></li>
								<li class="nav-item nav-item-has-subnav"><a
								href="javascript:void(0)"><i class="mdi mdi-file-outline"></i>
									程序代码管理</a>
							...
							<li class="nav-item nav-item-has-subnav active open"><a
								href="javascript:void(0)"><i class="mdi mdi-attachment"></i>
									附件</a>
								<ul class="nav nav-subnav">
									<li class="active"><a href="${pageContext.request.contextPath }/student/thesisAttachmentlist">附件上传 (学生)</a></li>
								</ul></li>
				...
				<nav class="navbar navbar-default">
					<div class="topbar">
						...
						<div class="topbar-left">
							...
							<span class="navbar-page-title"> 提交附件 </span>
						</div>
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-toolbar clearfix">
								<form id="form_query"
									action="${pageContext.request.contextPath }/student/thesisAttachmentlist"
									...
									<div class="input-group">
										...
										<input type="text" class="form-control"
											value="${thesisAttachment.fName}" name="fName"
											placeholder="请输入文件名称">
									</div>
								</form>
							</div>
							<div class="card-body">
							    ...
							    <input id="fType" type="text" name="fType" hidden="hidden" value="附件">
							    <input class="btn btn-default" id="file" name="uploadfile" accept=".zip" type="file" onchange="fileChange(this);"/>
							    <p></p> 
								...
								<div class="table-responsive">
									<table class="table table-bordered" id="tbodyID">
										...
										<tbody>
											<c:forEach var="thesisAttachment" items="${pageInfo.list }"
												varStatus="state">
												<tr>
													<td>${ state.index + 1}</td>
													<td>${thesisAttachment.titlName}</td>
													<td>${thesisAttachment.batch}</td>
													<td>${thesisAttachment.fName }</td>
													<td><fmt:formatDate value="${thesisAttachment.uploadDatetime }" pattern="yyyy-MM-dd hh:mm:ss"></fmt:formatDate></td>
													<td>${thesisAttachment.tName }</td>
													<td>
													<input type="button" class="btn btn-danger btn-xs" id="del"
																	name="del" value='删除' onclick='deleteThesisAttachment(${thesisAttachment.fId})'>
													<a href="${pageContext.request.contextPath }/file/filedown?fId=${thesisAttachment.fId}"><input type="button" class="btn btn-primary btn-xs" id="download"
