						...
						<ul class="nav nav-drawer">
							...
							<li class="nav-item nav-item-has-subnav"><a
								...
								href="javascript:void(0)"><i class="mdi mdi-file-outline"></i>
									程序代码管理</a>
								<ul class="nav nav-subnav">
									<li class="active"><a href="${pageContext.request.contextPath }/student/openReportlist">程序代码 (学生)</a></li>
								</ul></li>
				...
				<nav class="navbar navbar-default">
					<div class="topbar">
						...
						<div class="topbar-left">
							...
							<span class="navbar-page-title"> 提交程序代码 </span>
						</div>
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-toolbar clearfix">
								<form id="form_query"
									action="${pageContext.request.contextPath }/student/openReportlist"
							...
							<c:if test="${i eq 1 && i2 eq 0}">
							    ...
							    <input id="fType" type="text" name="fType" hidden="hidden" value="程序代码">
										...
										<tbody>
											<c:forEach var="openReport" items="${pageInfo.list }"
												...
												<tr>
													...
													<a href="${pageContext.request.contextPath }/file/filedown?fId=${openReport.fId}"><input type="button" class="btn btn-primary btn-xs" id="download"
						...
						<div class="modal-body">
							<form id="selectById_title_form">
										<div class="form-group">
											<label for="message-text" class="control-label">程序代码建议内容：</label>
