				...
				<div class="lyear-layout-sidebar-scroll">
					...
					<nav class="sidebar-main">
						<ul class="nav nav-drawer">
							<li class="nav-item"><a
								href="${pageContext.request.contextPath }/student/toindex"
							...
							<li class="nav-item nav-item-has-subnav"><a
								...
								<ul class="nav nav-subnav">
									<li><a
										href="${pageContext.request.contextPath }/student/projBooklist">技术文档</a></li>
								</ul></li>
							<li class="nav-item nav-item-has-subnav"><a
								href="javascript:void(0)"><i class="mdi mdi-file-outline"></i>
									程序代码管理</a>
								<ul class="nav nav-subnav">
									<li><a
										href="${pageContext.request.contextPath }/student/openReportlist">程序代码
											(学生)</a></li>
								</ul></li>
							...
							<li class="nav-item nav-item-has-subnav"><a
								...
								<ul class="nav nav-subnav">
									<li><a
										href="${pageContext.request.contextPath }/student/thesisAttachmentlist">附件上传
											(学生)</a></li>
								</ul></li>
							...
							<li class="nav-item nav-item-has-subnav"><a
								...
								<ul class="nav nav-subnav">
									<li><a
										href="${pageContext.request.contextPath }/student/studentScore">成绩总评
											(学生)</a></li>
								</ul></li>
						</ul>
					</nav>
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-toolbar clearfix">
								<form id="form_query"
									action="${pageContext.request.contextPath }/student/selTitleById"
	...
	function jumpPage(pageNumber){
	    ...
	    function delSelTitle(id) {
	    	if(confirm('确实要退选该课题吗?')) {
	    		$.post("<%=basePath%>student/delTitleInfoById",{"id":id},
	    		function(data){
	    		            if(data =="OK"){
	    		                alert("退选成功！");
	    ...
	    function newTitle() {
	    	...
	    	$.post("<%=basePath%>teacher/createTitle1",
