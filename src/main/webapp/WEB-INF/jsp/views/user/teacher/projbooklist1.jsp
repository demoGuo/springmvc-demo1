          ...
          <ul class="nav nav-drawer">
            ...
            <li class="nav-item nav-item-has-subnav active open">
              ...
              <ul class="nav nav-subnav">
                ...
                <li class="active"> <a href="${pageContext.request.contextPath }/teacher/projBooklist1">待审核技术文档</a> </li>
              </ul>
            </li>
            <li class="nav-item nav-item-has-subnav">
				...
				<nav class="navbar navbar-default">
					<div class="topbar">
						...
						<div class="topbar-left">
							...
							<span class="navbar-page-title"> 待审核技术文档 </span>
						</div>
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-toolbar clearfix">
								<form id="form_query"
									action="${pageContext.request.contextPath }/teacher/projBooklist"
												...
												<tr>
													...
													<input data-toggle="modal"
														data-target="#commentsInfoModal" type="button" class="btn btn-primary btn-xs" id="comment"
																	name="search2" value='审核' onclick="Values('${projBook.sId}',${projBook.fId})">
													<a href="${pageContext.request.contextPath }/file/filedown?fId=${projBook.fId}&tId=${projBook.tId}&tName=${projBook.tName}"><input type="button" class="btn btn-primary btn-xs" id="download"
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<input hidden type="text" id="sId" name="sId">
							<input hidden type="text" id="fId" name="fId">
							<input hidden type="text" id="role" name="role" value="技术文档">
										<div class="form-group">
											<label for="message-text" class="control-label">技术文档建议内容：</label>
											<div class="example-box">
												<textarea style="height: 200px"
													class="form-control" maxlength="255" name="content" id="content"></textarea>
											</div>
											<p></p>
											<div class="form-group">
	 ...
	 //清除建议模态框里的内容
	   // $("#comments_form").model("hide");
	    ...
	    function getcomment() {
	    	...
	    	$.post("<%=basePath%>comments/createComments",
