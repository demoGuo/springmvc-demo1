          ...
          <ul class="nav nav-drawer">
            ...
            <li class="nav-item nav-item-has-subnav active open">
              ...
              <ul class="nav nav-subnav">
                ...
                <li class="active"> <a href="${pageContext.request.contextPath }/teacher/openReportlist1">待审核程序代码</a> </li>
              </ul>
            </li>
				...
				<nav class="navbar navbar-default">
					<div class="topbar">
						...
						<div class="topbar-left">
							...
							<span class="navbar-page-title"> 待审核程序代码 </span>
						</div>
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-toolbar clearfix">
								<form id="form_query"
									action="${pageContext.request.contextPath }/teacher/openReportlist1"
										...
										<tbody>
											<c:forEach var="openReport" items="${pageInfo.list }"
												...
												<tr>
													...
													<td>${openReport.sName}</td>
													<td>${openReport.major}</td>
													...
													<input data-toggle="modal"
														data-target="#commentsInfoModal" type="button" class="btn btn-primary btn-xs" id="comment"
																	name="search2" value='审核' onclick="Values('${openReport.sId}',${openReport.fId})">
													<a href="${pageContext.request.contextPath }/file/filedown?fId=${openReport.fId}&tId=${openReport.tId}&tName=${openReport.tName}"><input type="button" class="btn btn-primary btn-xs" id="download"
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<input hidden="hidden" type="text" id="role" name="role" value="程序代码">
