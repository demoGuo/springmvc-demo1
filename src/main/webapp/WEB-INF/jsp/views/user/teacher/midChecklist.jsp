				...
				<nav class="navbar navbar-default">
					<div class="topbar">
						...
						<div class="topbar-left">
							...
							<span class="navbar-page-title"> 已审核中期检查 </span>
						</div>
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-toolbar clearfix">
								<form id="form_query"
									action="${pageContext.request.contextPath }/teacher/midChecklist"
												...
												<tr>
													...
													<input data-toggle="modal"
														data-target="#commentsInfoModal" type="button" class="btn btn-primary btn-xs" id="comment"
																	name="search2" value='审核' onclick="getcomment(${midCheck.fId})">
													<a href="${pageContext.request.contextPath }/file/filedown?fId=${midCheck.fId}&tId=${midCheck.tId}&tName=${midCheck.tName}"><input type="button" class="btn btn-primary btn-xs" id="download"
						...
						<div class="modal-body">
							<form id="selectById_title_form">
										<div class="form-group">
											<label for="message-text" class="control-label">中期检查建议内容：</label>
