      ...
      <div class="lyear-layout-sidebar-scroll"> 
        ...
        <nav class="sidebar-main">
          <ul class="nav nav-drawer">
            <li class="nav-item active"> <a href="${pageContext.request.contextPath }/teacher/toindex"><i class="mdi mdi-home"></i> 首页</a> </li>
...
function editInfo() {
	...
	$.post("<%=basePath%>teacher/editInfo",$("#edit_student_form").serialize(),function(data){
		if(data =="OK"){
