...
<body>
        ...
        <nav class="sidebar-main">
          <ul class="nav nav-drawer">
            ...
            <li class="nav-item nav-item-has-subnav open active">
              ...
              <ul class="nav nav-subnav">
                <li class="active"> <a href="${pageContext.request.contextPath }/admin/todeptlist">系部/专业</a> </li>
              </ul>
            </li>
            <li class="nav-item nav-item-has-subnav">
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-toolbar clearfix">
								<form id="form_query"
									action="${pageContext.request.contextPath }/admin/todeptlist"
										...
										<tbody>
											<c:forEach var="BaseDept" items="${pageInfo.list }"
												...
												<tr>
													...
													<td><button style="border:0;background: none;" type="button"><a href="${pageContext.request.contextPath }/admin/tomajorlist?deptId=${BaseDept.deptId }">${BaseDept.deptName }</a></button></td>
	...
	function jumpPage(pageNumber){
	  ...
	  function createDept() {
		  ...
		  $.post("<%=basePath%>admin/createDept",
	  ...
	  function editDept(deptId) {
		    $.ajax({
		        type:"get",
		        url:"<%=basePath%>admin/getDeptById",
		        data:{"deptId":deptId},
	  ...
	  function saveDeptinfo() {
		  ...
		  $.post("<%=basePath%>admin/updateDept",$("#edit_dept_form").serialize(),function(data){
				if(data =="OK"){
					alert("系部信息更新成功！");
					window.location.reload();
				}else{
	  ...
	  function deleteDept(deptId,s) {
		  if(confirm('确实要删除/恢复该系吗?')){
			  $.post("<%=basePath%>admin/deleteDept",{"deptId":deptId,"s":s},function(data){
					if(data =="OK"){
						alert("操作成功！");
						window.location.reload();
					}else{
