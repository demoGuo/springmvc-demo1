      ...
      <div class="lyear-layout-sidebar-scroll"> 
        ...
        <nav class="sidebar-main">
          <ul class="nav nav-drawer">
            <li class="nav-item active"> <a href="${pageContext.request.contextPath }/admin/toindex" onclick="location.reload()"><i class="mdi mdi-home"></i> 首页</a> </li>
          ...
          <ul class="topbar-right">
            <li class="dropdown dropdown-profile">
              ...
              <ul class="dropdown-menu dropdown-menu-right">
                <li> <a href="${pageContext.request.contextPath }/admin/toeditPwd"><i class="mdi mdi-lock-outline"></i> 修改密码</a> </li>
                <li class="divider"></li>
...
function editPwd() {
	...
	$.post("<%=basePath%>admin/editPwd",$("#edit_student_form").serialize(),function(data){
		if(data =="OK"){
			lightyear.loading('hide');
