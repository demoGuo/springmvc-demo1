...
<body>
          ...
          <ul class="nav nav-drawer">
            ...
            <li class="nav-item nav-item-has-subnav open active">
              ...
              <ul class="nav nav-subnav">
                <li> <a href="${pageContext.request.contextPath }/admin/toteacherlist">教师信息管理</a> </li>
                <li class="active"> <a href="${pageContext.request.contextPath }/admin/tostudentlist">学生信息管理</a> </li>
              </ul>
            </li>
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<div class="card">
							<div class="card-toolbar clearfix">
								<form id="form_query"
									action="${pageContext.request.contextPath }/admin/tostudentlist"
		           ...
		           data-target="#newStudentDialog" onclick="clearStudent()"><label><i class="mdi mdi-checkbox-marked-circle-outline"></i></label>添加</button>
								<a href="${pageContext.request.contextPath }/admin/toteacherlist1" ><label><i class="mdi mdi-checkbox-marked-circle-outline"></i></label>数据导出</a>
								<p></p>
	...
	function jumpPage(pageNumber){
	  ...
	  function createStudent() {
		  ...
		  $.post("<%=basePath%>admin/createStudent",
	  ...
	  function editStudent(sId) {
		    $.ajax({
		        type:"get",
		        url:"<%=basePath%>admin/getStudentBysId",
		        data:{"sId":sId},
	  ...
	  function saveStudentinfo() {
		  ...
		  $.post("<%=basePath%>admin/updateStudent",$("#selectById_student_form").serialize(),function(data){
				if(data =="OK"){
					alert("学生信息更新成功！");
					window.location.reload();
				}else{
	  ...
	  function deleteTitle(sId,s) {
		  if(confirm('确实要删除/恢复该学生吗?')){
			  $.post("<%=basePath%>admin/deleteStudent",{"sId":sId,"s":s},function(data){
					if(data =="OK"){
						alert("操作成功！");
						window.location.reload();
					}else{
	  ...
	  function change2() {
		  ...
		  $.ajax({
			   type : "POST",
			   url : "<%=basePath%>admin/changeDept1",
			   data : {"dept":dept},
			   dataType : "json",
			   success: function (date) {
                   var optionstring = "";
