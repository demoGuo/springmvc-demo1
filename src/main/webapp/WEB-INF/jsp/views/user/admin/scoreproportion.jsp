        ...
        <nav class="sidebar-main">
          <ul class="nav nav-drawer">
            ...
            <li class="nav-item nav-item-has-subnav open active">
              ...
              <ul class="nav nav-subnav">
                <li class="active"> <a href="${pageContext.request.contextPath }/admin/scoreproportion">修改成绩比重</a> </li>
              </ul>
            </li>
          </ul>
        </nav>
	  ...
	  function change1(val) {
	    ...
	    function save() {
	    	var tScoreProportion = $("#tScoreProportion").val();
		      ...
		      $.post("<%=basePath%>admin/saveScoreProportion",{"tScoreProportion":tScoreProportion,"leaderScoreProportion":leaderScoreProportion,"reviewScoreProportion":reviewScoreProportion},function(data){
					if(data =="OK"){
						alert("操作成功！");
						window.location.reload();
					}else{
