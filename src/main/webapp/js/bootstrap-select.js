(function ($) {
  ...
  Selectpicker.prototype = {
    ...
    createDropdown: function () {
      ...
      if (this.multiple && this.optionssBox) {
        actionsbox =
    ...
    liHeight: function (refresh) {
      ...
      var newElement = document.createElement('div'),
          ...
          actions = this.optionssBox && this.multiple && this.$menu.find('.bs-actionsbox').length > 0 ? this.$menu.find('.bs-actionsbox')[0].cloneNode(true) : null,
      ...
      this.sizeInfosHeight = actionsHeight;
    ...
    setMenuSize: function (isAuto) {
      ...
      var selectWidth = this.sizeInfo.selectWidth,
          ...
          actionsHeight = this.sizeInfosHeight,
    ...
    clickListener: function () {
      ...
      this.$menu.on('click', 's-btn', function (e) {
        if (that.options.liveSearch) {
          that.$searchbox.trigger('focus');
        } else {
          that.$button.trigger('focus');
